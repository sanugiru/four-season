...
var mat_green = new THREE.MeshLambertMaterial({ color: 0x04E128 });
var mat_greenL = new THREE.MeshLambertMaterial({ color: 0x78FF29 });
var mat_Summer = new THREE.MeshLambertMaterial({ color: 0xD3FF19 });
var mat_SummerL = new THREE.MeshLambertMaterial({ color: 0xE5F80E});
//-------------------------------------ground-------------------------------------
var layers = [];
...
for (var i = 0; i < 5; i++) {
  ...
  layers.push(new THREE.Mesh(geometry, mat_SummerL));
...
var crown = new THREE.Mesh(geo_crown, mat_Summer);
crown.scale.y = 1.8;
crown.scale.x = 2.3;
crown.scale.z = 1.3;
...
var blade = new THREE.Mesh(geo_blade, mat_SummerL);
