...
var ambientLight = new THREE.AmbientLight(0xFFAE6D, 0.5);
...
var mat_fall = new THREE.MeshLambertMaterial({ color: 0xFFDC00});
//-------------------------------------ground-------------------------------------
var layers = [];
...
var blade = new THREE.Mesh(geo_blade, mat_fall);
