...
var ambientLight = new THREE.AmbientLight(0xFFF9CA, 0.5);
...
var fillLight = new THREE.DirectionalLight(0xCEEDC7, 0.3);
fillLight.position.set(-20, 20, 20);

var backLight = new THREE.DirectionalLight(0x86C8BC, 0.3);
...
var mat_greenL = new THREE.MeshStandardMaterial({ color: 0xB6E388 });
//-------------------------------------ground-------------------------------------
var layers = [];
...
for (var i = 0; i < 5; i++) {
  ...
  layers.push(new THREE.Mesh(geometry, mat_greenL));
...
var crown = new THREE.Mesh(geo_crown, mat_greenL);
crown.scale.y = 2.5;
crown.scale.x = 3;
crown.scale.z = 2;
...
var blade = new THREE.Mesh(geo_blade, mat_greenL);
